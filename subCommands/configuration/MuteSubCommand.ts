import { ChatInputCommandInteraction, Role, inlineCode } from "discord.js";
...
export default class MuteSub extends SubCommand {
    ...
    async Execute(interaction: ChatInputCommandInteraction) {
        ...
        await interaction.reply({ content: `${inlineCode('✔️')} The muting plugin has been successfully configured.`, ephemeral: false });
    }
}